...
export const POST = buatEndpoint(
  {
    ...
    createSiswa: (args) => createSiswa(args[0] as never, args[1] as never, args[2] as never, args[3] as never, args[4] as never, args[5] as never, args[6] as never, args[7] as never),
